...
import Tarefas from '../../services/TarefaService';
import DateTimePicker from '@react-native-community/datetimepicker';
import { Feather } from '@expo/vector-icons';
import normalizador from '../../util/normalizador';
import { useNavigation } from '@react-navigation/native';
import schedulePushNotification from '../../services/Notifications'
import formatTime from '../../util/dateFormat';
import BarraSuperior from '../../util/BarraSuperior'
...
export default function Cadastro() {
    ...
    function dados(IdFinal){
        Tarefas.create({id: id, idCategoria: id_categoria, titulo: titulo, descricao: descricao, dataInicio: date_inicio.toString(), dataFim: date_fim.toString(), status: status, bloco: bloco, concluidaEm: concluidaEm})
                .then(() => {
